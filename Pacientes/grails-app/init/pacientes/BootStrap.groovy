...
class BootStrap {
    ...
    def paciente1 = new Paciente(fechaNacimiento:Date.parse('yyyy-MM-dd','2015-10-20'),nroDocumento:39805640,apellido:'MIRANDA',sexo:'M')
